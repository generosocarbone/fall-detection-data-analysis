...
def set_parameters(csv_path, csv_name, G, ACCELERATION_IMPACT_COEFFICIENT, ACCELERATION_FREE_FALL_COEFFICIENT, MIN_SQM, MAX_SPIKES, MEDIANA_INTERVAL_SIZE, LOWER_BOUND_MEDIANA, UPPER_BOUND_MEDIANA):
    ...
    stasi.plot.line(title=csv_name)

#for i in range(1):
csv_path='davide'
csv_name='fall_20210413.shock'
full_name='{}_stasi_{}'.format(csv_name, 1)
# print("\n==================== NEW RUN (1) ====================\n")
...
print("\n==================== NEW RUN (5) ====================\n")
set_parameters(csv_path, full_name, 9.81, 2.5, 0.3, 1.0, 2, 17, 0.89, 1.13)
print("\n==================== NEW RUN (6) ====================\n")
set_parameters(csv_path, full_name, 9.81, 2.5, 0.3, 1.0, 2, 20, 0.89, 1.13)
print("\n==================== NEW RUN (7) ====================\n")
set_parameters(csv_path, full_name, 9.81, 2.5, 0.3, 1.0, 2, 17, 0.93, 1.03)
print("\n==================== NEW RUN (8) ====================\n")
set_parameters(csv_path, full_name, 9.81, 2.5, 0.3, 1.0, 2, 20, 0.93, 1.03)
print("\n==================== END RUN ====================\n")
